...
def load_receipt_bound_frozen_dino(
    *,
    ...
    """Reused from embedding.methods.nose.training.trainer — identical contract."""
    from embedding.methods.nose.training.trainer import load_receipt_bound_frozen_dino as _loader
