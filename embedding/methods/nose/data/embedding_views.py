...
_PRE_EMBEDDING_SHA256_PATHS = tuple(
    ...
    if path == "embedding/methods/nose/data/embedding_views.py"
    else path
    for path in _SHA256_PATHS
)
...
def prepare_embedding_views(
    *,
    ...
    from parsing.nose_region.segmentation_training import validate_lineage_manifest
