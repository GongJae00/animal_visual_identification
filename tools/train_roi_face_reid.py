...
def main() -> None:
    ...
    from cvi.face_id.evaluation import (
    ...
    train_dataset = RoiFaceReIDDataset(
        crop_root, train_records, train_index, augment=PhotometricAugment()
    )
    dev_dataset = RoiFaceReIDDataset(crop_root, dev_records, dev_index)
    ...
    faceid_contract = build_faceid_contract(
    ...
    summary = {
        "schema_version": "cvi.faceid_training_summary.v1",
        "seed": args.seed,
        "epochs": args.epochs,
