...
from cvi.protected_evaluation import prepare_protected_evaluation
...
def main() -> None:
    ...
    provenance = build_offline_tool_provenance(
        Path(__file__),
        additional_paths=(
            root / "src" / "cvi" / "protected_evaluation.py",
            root / "src" / "cvi" / "protected_io.py",
            root / "src" / "cvi" / "role_exposure.py",
        ),
    )
