...
from cvi.public_canine_semantic_intake import derive_public_canine_semantics
from cvi.public_dataset_receipt_io import read_public_archive_receipt_bundle
from cvi.split_registry_binding import validate_assignment_and_evaluator_binding
from cvi.training_admission import TrainingAdmissionReceipt

if __package__:
    from tools.evaluate_roi_reid import _reconstruct_dinov2_model
else:
