...
from cvi.evaluation.embedding_diagnostics import compute_embedding_diagnostics
...
from cvi.face_id.checkpoint import (
    build_faceid_contract,
    file_sha256,
    normalize_dino_local_artifact_contract,
    validate_checkpoint_runtime_bindings,
    validate_checkpoint_structure,
)
from cvi.face_id.trainer import build_faceid_model, load_receipt_bound_frozen_dino
from cvi.fusion.oof_simplex import OOFSimplexConfig, fit_oof_simplex
...
from cvi.public_canine_manifest import DOGFACE_DATASET
from cvi.public_dataset_receipt_io import read_public_archive_receipt_bundle
...
from cvi.split_role_exposure import verify_split_role_exposure_inputs

if __package__:
    from tools import evaluate_external_appearance as external
...
_CODE_PATHS = (
    "tools/evaluate_dogface_holdout_fusion.py",
    "tools/evaluate_external_appearance.py",
    "tools/evaluate_roi_reid.py",
    "src/cvi/trainer.py",
    "src/cvi/train/config.py",
    "src/cvi/evidence/appearance.py",
    "src/cvi/evidence/dinov2_contract.py",
    "src/cvi/face_id/checkpoint.py",
    "src/cvi/face_id/dataset.py",
    "src/cvi/face_id/model.py",
    "src/cvi/face_id/trainer.py",
    "src/cvi/face_id/evaluation.py",
    "src/cvi/nose_id/trainer.py",
    "src/cvi/evaluation/embedding_diagnostics.py",
    "src/cvi/evaluation/robustness_protocol.py",
    "src/cvi/evaluation/retrieval.py",
    "src/cvi/evaluation/calibration.py",
    "src/cvi/fusion/oof_simplex.py",
    "src/cvi/role_exposure.py",
    "src/cvi/protected_io.py",
    "src/cvi/protected_public_split.py",
    "src/cvi/public_canine_manifest.py",
    "src/cvi/public_canine_semantic_intake.py",
    "src/cvi/public_dataset_receipt_io.py",
    "src/cvi/training_admission.py",
    "src/cvi/identity_registry.py",
    "src/cvi/split_role_exposure.py",
    "src/cvi/split_registry_binding.py",
)
...
def _load_models(
    ...
    face_contract = build_faceid_contract(
        file_sha256(repository / "src/cvi/face_id/model.py"),
        file_sha256(repository / "src/cvi/face_id/dataset.py"),
    )
