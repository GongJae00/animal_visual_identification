...
from cvi.public_canine_manifest import ArchiveReceiptBinding, YT_DATASET, parse_yt_bb_dog
...
from cvi.split_registry_binding import validate_assignment_receipt_binding
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    provenance = build_offline_tool_provenance(
        Path(__file__),
        additional_paths=(
            repository_root / "src/cvi/nose_region/native_yt.py",
            repository_root / "src/cvi/nose_region/localizer.py",
            repository_root / "src/cvi/nose_region/manifest.py",
        ),
    )
    input_hashes = {
