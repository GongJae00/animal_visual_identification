...
Usage:
    ...
    uv run python tools/download_datasets.py --dataset yt-bb-dog
    uv run python tools/download_datasets.py --list

Data root resolution:
    1. ``--data-root``
    2. ``CVI_DATA_DIR`` when set before startup
    3. ``~/cvi_data``
"""
...
from cvi.model_paths import DATA_DIR, SUPPORTED_DATASETS
