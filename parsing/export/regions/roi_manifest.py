"""Export detector predictions as instance-level identity crop manifests."""
...
from parsing.export.detection.consensus import consensus_dog_instances
from parsing.export.detection.prediction_cache import cache_record_to_result
from parsing.export.quality.quality import (
    estimate_blur,
    score_dog_quality,
    score_face_quality,
)
from parsing.export.crops.roi import (
    compute_iou,
