...
from parsing.export.regions.manifest import frontality_from_keypoints, normalized_box_to_pixel_box
...
def predict_localizer(model: Any, device: Any, image: Image.Image) -> list[list[float]]:
    ...
    from parsing.export.regions.localizer import INPUT_SIZE, image_to_tensor
