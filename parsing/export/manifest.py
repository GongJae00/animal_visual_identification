...
from shared.contracts.prompt_segmentation_model import (
...
from shared.foundation.protected_publication import fsync_directory
...
_SOURCE_PATHS = (
    "archive/full128/methods/preparation/materialization.py",
    ...
    "parsing/export/segmentation/full_segment_cache.py",
)
