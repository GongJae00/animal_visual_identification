...
| [appearance_face_nose/](appearance_face_nose/README.md) | A0 vs Face vs Nose vs fusions | Keep A0 | one page |
| [nose_metric/](nose_metric/README.md) | N3 vs N4 residual adapter | Not promoted | one page |
...
`shared_helpers/` is shared helpers and example configs, not an ablation.

```bash
uv run python archive/<set>/commands/<command>.py --help
```
