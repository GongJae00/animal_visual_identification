...
```bash
uv run python archive/appearance_face_nose/commands/audit_sibetan_diagnostics.py --help
uv run python archive/appearance_face_nose/commands/build_fixed_multievidence_panel.py --help
uv run python archive/appearance_face_nose/commands/evaluate_fixed_multievidence.py --help
uv run python archive/appearance_face_nose/commands/evaluate_sibetan_multievidence.py --help
uv run python archive/appearance_face_nose/commands/evaluate_yt_unified_multievidence.py --help
```
