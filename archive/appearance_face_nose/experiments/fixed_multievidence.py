...
_PRE_TRAINING_OWNERSHIP_PANEL_CODE_PATHS = tuple(
    ...
    for path in _PRE_PARSING_PANEL_CODE_PATHS
)
...
_EVALUATION_CODE_PATHS = (
    ...
    "identification/export/face/residual_model.py",
    "archive/appearance_face_nose/commands/evaluate_fixed_multievidence.py",
)
...
def build_topology_manifest(
    ...
    *,
    ...
    from archive.shared_helpers.experiments.identity_topology import (
...
def evaluate_fixed_panel(
    *,
    ...
    from identification.training.face.dataset import prepare_roi_face_input
    ...
    report = {
        ...
        "code_sha256s": _code_sha256s(
            ...
            (
                *_EVALUATION_CODE_PATHS,
                *(("archive/shared_helpers/experiments/identity_topology.py",) if topology_manifest is not None else ()),
            ),
        ),
