...
from evaluation.search_metrics.metrics import compute_cosine_score_matrix, identity_clustered_bootstrap_ci
...
def frozen_transfer_weights(yt_report: Mapping[str, Any]) -> dict[str, dict[str, float]]:
    ...
    from archive.appearance_face_nose.experiments.unified_multievidence import validate_report_bundle
