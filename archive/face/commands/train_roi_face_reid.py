...
from shared.foundation.provenance import git_worktree_provenance as _git_provenance
...
def main() -> None:
    ...
    from identification.training.face.dataset import RoiFaceReIDDataset
    from archive.face.experiments.face_evaluation import (
        evaluate_face_retrieval,
        extract_face_embeddings,
    )
    from identification.training.face.losses import FaceIDObjective, FaceResidualObjective
    from identification.training.face.sampler import FaceReIDSampler
