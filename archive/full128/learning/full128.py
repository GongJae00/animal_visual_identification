...
from archive.full128.methods.models.classical import (
    Classical128,
...
def run_full128_training(
    *,
    ...
    workflow = repository / "archive/full128/commands" / "run_full128_training.py"
    source_closure = build_offline_tool_provenance(
        workflow, logical_component="archive.full128.commands.run_full128_training"
    )
