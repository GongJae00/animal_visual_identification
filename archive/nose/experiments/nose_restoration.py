...
from evaluation.search_metrics.metrics import compute_cosine_score_matrix
from shared.foundation.protected_io import read_strict_json_document, write_private_json_bundle
from shared.foundation.provenance import content_sha256
from identification.export.nose.signal.restoration import RestorationConfig, restore_nose_frames
...
_CODE_PATHS = (
    "archive/nose/experiments/nose_restoration.py",
    "identification/export/nose/signal/restoration.py",
    "identification/export/nose/signal/temporal.py",
    "shared/contracts/artifact_manifest.py",
    "parsing/export/regions/native_yt.py",
    "archive/nose/commands/evaluate_yt_nose_restoration.py",
)
