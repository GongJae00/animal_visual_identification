...
from shared.contracts.artifact_manifest import ExactOnnxRuntime, NoseEmbeddingManifest
...
from identification.export.nose.signal.frequency import classical_texture_descriptors
...
_CODE_PATHS = (
    "archive/nose/experiments/nose_texture.py",
    "identification/export/nose/signal/frequency.py",
    ...
    "archive/nose/commands/evaluate_yt_nose_texture.py",
)
