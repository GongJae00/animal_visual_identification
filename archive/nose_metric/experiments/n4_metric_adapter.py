...
_CACHE_CODE_PATHS = (
    "archive/nose_metric/experiments/n4_metric_adapter.py",
    "archive/nose_metric/commands/materialize_n4_embedding_cache.py",
)
_TRAIN_CODE_PATHS = (
    "archive/nose_metric/experiments/n4_metric_adapter.py",
    "archive/nose_metric/commands/train_n4_metric_adapter.py",
)
_EVALUATION_CODE_PATHS = (
    "archive/nose_metric/experiments/n4_metric_adapter.py",
    "archive/nose_metric/commands/evaluate_n4_metric_adapter.py",
)
