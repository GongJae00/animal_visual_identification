...
_EVALUATION_CODE_PATHS = (
    ...
    "legacy/version/afn/workflows/evaluate_fixed_multievidence.py",
)
    ...
    *,
    ...
    report = {
        ...
        "code_sha256s": _code_sha256s(
            ...
            (
                *_EVALUATION_CODE_PATHS,
                *(("legacy/version/common/experiments/identity_topology.py",) if topology_manifest is not None else ()),
            ),
        ),
