...
from legacy.version.common.experiments.sibetan_evidence import validate_evidence_bundle_v2
...
from legacy.version.afn.experiments.unified_multievidence import _extract_dino_embeddings, _read_bound_rgb
...
if __package__:
    from legacy.version.common.workflows.evaluate_external_appearance import (
...
def _adapt_nose_embeddings(checkpoint, embeddings):
    if not embeddings:
        return {}
    from legacy.version.n4.experiments.n4_metric_adapter import apply_adapter
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    if args.n4_checkpoint is not None:
        from legacy.version.n4.experiments.n4_metric_adapter import load_adapter_checkpoint
            ...
            **(
            ...
            "code_sha256s": {
                ...
                for row in build_source_provenance(
                    (repository / "legacy/version/afn/workflows/evaluate_sibetan_multievidence.py",)
                )["code_source_files"]
            },
        },
    }
