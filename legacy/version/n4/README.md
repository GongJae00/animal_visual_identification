...
```bash
uv run python legacy/version/n4/workflows/evaluate_n4_metric_adapter.py --help
uv run python legacy/version/n4/workflows/evaluate_n4_robust_nose.py --help
uv run python legacy/version/n4/workflows/materialize_n4_embedding_cache.py --help
uv run python legacy/version/n4/workflows/train_n4_metric_adapter.py --help
```
