...
_CACHE_CODE_PATHS = (
    "legacy/version/n4/experiments/n4_metric_adapter.py",
    "legacy/version/n4/workflows/materialize_n4_embedding_cache.py",
)
_TRAIN_CODE_PATHS = (
    "legacy/version/n4/experiments/n4_metric_adapter.py",
    "legacy/version/n4/workflows/train_n4_metric_adapter.py",
)
_EVALUATION_CODE_PATHS = (
    "legacy/version/n4/experiments/n4_metric_adapter.py",
    "legacy/version/n4/workflows/evaluate_n4_metric_adapter.py",
)
