...
if __package__:
    from legacy.version.common.workflows import evaluate_external_appearance as external
...
_CODE_PATHS = (
    "legacy/version/face/workflows/evaluate_dogface_holdout_fusion.py",
    "legacy/version/common/workflows/evaluate_external_appearance.py",
    "legacy/version/common/workflows/evaluate_roi_reid.py",
    ...
    "legacy/version/face/experiments/face_evaluation.py",
