...
from cvi.nose_region.localizer import KEYPOINT_ORDER, NOSE_POINT_INDICES
from cvi.nose_region.manifest import frontality_from_keypoints, normalized_box_to_pixel_box
...
def predict_localizer(model: Any, device: Any, image: Image.Image) -> list[list[float]]:
    ...
    from cvi.nose_region.localizer import INPUT_SIZE, image_to_tensor
