...
from cvi.nose_region.manifest import read_nose_region_manifest
...
def _bindings(**values: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "code_sha256s": {
            ...
            for relative in (
                "src/cvi/nose_region/embedding_consistency_training.py",
                "src/cvi/nose_region/embedding_training.py",
                "src/cvi/nose_region/embedding_views.py",
                "src/cvi/nose_region/native_yt.py",
                "tools/train_nose_region_consistency.py",
            )
        },
...
def _validate_bindings(bindings: object) -> None:
    ...
    if not isinstance(code, dict) or len(code) != 5:
