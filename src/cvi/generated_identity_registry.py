...
CVI_GENERATED_DOG_NAMESPACE = uuid.uuid5(uuid.NAMESPACE_DNS, "cvi.generated_dog.v1")
...
def compute_source_cluster_token(source_cluster_id: str) -> str:
    ...
    return hashlib.sha256(
        _CLUSTER_TOKEN_PREFIX + source_cluster_id.encode("utf-8")
    ).hexdigest()


def compute_generated_identity_id(generator_id: str, source_cluster_token: str) -> str:
    _validate_generator_id(generator_id)
    _validate_sha256(source_cluster_token, "source_cluster_token")
    return str(
        uuid.uuid5(
...
class GeneratedIdentityRegistry:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "namespace_uuid": str(CVI_GENERATED_DOG_NAMESPACE),
    ...
    def from_dict(cls, payload: dict[str, Any]) -> GeneratedIdentityRegistry:
        ...
        if payload["schema_version"] != _SCHEMA_VERSION:
            raise ValueError("unsupported generated identity registry schema")
        if payload["namespace_uuid"] != str(CVI_GENERATED_DOG_NAMESPACE):
