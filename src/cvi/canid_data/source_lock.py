...
from cvi.model_paths import DATASETS_DIR
...
SOURCE_REGISTRY: tuple[CanidDatasetRecord, ...] = (
    ...
    CanidDatasetRecord(
        ...
        notes="Publisher reports 1,657 images of 192 dogs captured with varied "
        "poses and perspectives; retained for validation protocols only.",
    ),
    CanidDatasetRecord(
