...
_CODE_PATHS = (
    "src/cvi/nose_id/architecture_evaluation.py",
    ...
    "tools/evaluate_yt_nose_architecture.py",
)
_IMAGE_SIZE = 224
...
def _load_consistency_lineage(
    *,
    ...
    from cvi.nose_region.embedding_consistency_training import validate_lineage_manifest
