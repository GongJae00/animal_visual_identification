...
_EXPORTS = {
    ...
    "RestorationConfig": ("cvi.nose_id.restoration", "RestorationConfig"),
    "RestorationDiagnostics": ("cvi.nose_id.restoration", "RestorationDiagnostics"),
    "RestorationResult": ("cvi.nose_id.restoration", "RestorationResult"),
    "restore_nose_frames": ("cvi.nose_id.restoration", "restore_nose_frames"),
    "TemporalEmbeddingResult": ("cvi.nose_id.temporal", "TemporalEmbeddingResult"),
    "aggregate_nose_embeddings": ("cvi.nose_id.temporal", "aggregate_nose_embeddings"),
