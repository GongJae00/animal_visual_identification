...
from cvi.localization.types import DetectionBox, LocalizationResult
from cvi.protected_io import read_content_hashed_json_bundle, write_private_json_bundle
from cvi.provenance import content_sha256

_BUNDLE_SCHEMA = "cvi.localization_prediction_cache_bundle.v1"
_CACHE_SCHEMA = "cvi.localization_prediction_cache.v1"
_MODEL_FIELDS = {
    "family",
    "name",
    "artifact_sha256",
...
def cache_record_to_result(
    ...
    from cvi.localization.types import Keypoint, KeypointSet
