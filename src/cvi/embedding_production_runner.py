...
class EmbeddingProductionPrecommitment:
    ...
    def __post_init__(self) -> None:
        ...
        if self.worker_bootstrap_sha256 != EMBEDDING_WORKER_BOOTSTRAP_SHA256:
...
def run_embedding_production_fresh_worker(
    *,
    ...
    with TemporaryDirectory(
        ...
        code_package_root = code_root / "cvi"
        code_package_root.mkdir(mode=0o700)
...
def _validate_outer_common(value: Any) -> None:
    ...
    if len(command) != 10 or command[:5] != (
        ...
        "-I", "-B", "-c", EMBEDDING_WORKER_BOOTSTRAP,
