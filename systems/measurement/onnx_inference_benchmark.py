...
from systems.measurement.telemetry import GpuTelemetrySummary, monitor_operation
...
_BENCHMARK_WORKER_MODULES = {
    ...
    "systems.measurement.onnx_inference_benchmark",
}
_CURRENT_BENCHMARK_WORKER_MODULE = "systems.measurement.onnx_inference_benchmark"
...
def _validate_worker_result(
    ...
    *,
    ...
    from systems.inference.embedding_producer import EmbeddingBackendIdentity
