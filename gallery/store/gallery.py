...
from shared.foundation.protected_publication import rename_directory_noreplace
...
class IdentityGallery:
    """Generation-published key/value gallery with exact sparse-channel scoring."""
