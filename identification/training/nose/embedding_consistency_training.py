...
from identification.export.nose.data.embedding_views import (
...
_CODE_PATHS = (
    ...
    "identification/training/nose/embedding_training.py",
    "identification/export/nose/data/embedding_views.py",
    "parsing/export/regions/native_yt.py",
    "archive/nose/commands/train_nose_region_consistency.py",
)
...
_PRE_EMBEDDING_CODE_PATHS = tuple(
    path.replace(
        "identification/training/nose/", "parsing/nose_region/", 1
    ).replace(
        "identification/export/nose/data/embedding_views.py",
        "parsing/nose_region/embedding_views.py",
        1,
    )
    for path in _PRE_PARSING_CODE_PATHS
)
