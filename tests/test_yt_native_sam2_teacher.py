...
from legacy.version.nose.workflows.produce_yt_native_nose_teacher_masks import run as run_tool
...
def test_tool_help_does_not_import_sam2() -> None:
    tool = Path(__file__).parents[1] / "legacy/version/nose/workflows" / "produce_yt_native_nose_teacher_masks.py"
    command = (
