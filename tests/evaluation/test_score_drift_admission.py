...
import operations.workers.embedding_production_runner as embedding_runner
from shared.contracts.runtime_library_provenance import RuntimeLibraryManifest
    ...
    def test_protected_cli_writes_hashed_private_no_overwrite_bundle(self) -> None:
        with TemporaryDirectory() as temporary:
            ...
            precommitment_command = [
                sys.executable,
                "evaluation/commands/compare_score_drift.py",
                "precommit",
            ]
            for name in (
                "workload",
