...
class BatchInvarianceTests(unittest.TestCase):
    ...
    def test_worker_policy_and_environment_mismatch_fail_before_launch(self) -> None:
        with TemporaryDirectory() as temporary:
            ...
            with patch(
                "operations.workers.batch_invariance_runner.run_supervised_process"
            ) as launch:
    ...
    def test_precommitment_and_external_verifier_cli_roundtrip(self) -> None:
        with TemporaryDirectory() as temporary:
            ...
            command = [
                sys.executable,
                "evaluation/commands/create_batch_invariance_precommitment.py",
            ...
            supervised = SupervisedProcessResult(
                command=(
                    ...
                    ISOLATED_WORKER_BOOTSTRAP,
                    "operations.workers.batch_invariance_worker", "/tmp/request",
            ...
            verified = subprocess.run(
                [
                    sys.executable,
                    "operations/workers/verify_batch_invariance_receipt.py",
