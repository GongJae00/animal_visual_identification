...
from shared.contracts.foundation_vision_model import FoundationFileBinding
...
from parsing.export.regions.sam2_prompt_runtime import _validate_box, _validate_point
