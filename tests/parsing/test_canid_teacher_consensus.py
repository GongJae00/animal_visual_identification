...
from parsing.export.detection.consensus import (
...
class QualityScoringTests(unittest.TestCase):
    def test_dog_quality_is_normalized(self) -> None:
        from parsing.export.quality.quality import score_dog_quality
    ...
    def test_face_quality_yaw_proxy(self) -> None:
        from parsing.export.quality.quality import score_face_quality
    ...
    def test_nose_quality_all_inputs_mapped(self) -> None:
        from parsing.export.quality.quality import score_nose_quality
