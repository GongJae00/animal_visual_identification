...
from archive.shared_helpers.commands.audit_identity_topology import REPORT_BUNDLE_SCHEMA_VERSION, main
...
class IdentityTopologyCliTests(unittest.TestCase):
    def test_cli_writes_bound_canonical_bundle_and_refuses_overwrite(self) -> None:
        with TemporaryDirectory() as temporary:
            ...
            self.assertTrue(
                {
                    "archive/shared_helpers/experiments/identity_topology.py",
                    "archive/shared_helpers/commands/audit_identity_topology.py",
