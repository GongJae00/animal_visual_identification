...
from identification.export.face import checkpoint as faceid_checkpoint
from shared.foundation import provenance
...
@pytest.mark.parametrize(
    ...
    [
        ("archive/face/commands/train_roi_face_reid.py", "{cpu,cuda}"),
        ("archive/face/commands/evaluate_trained_face_reid.py", "--expected-split-role"),
    ],
)
