...
from archive.face.commands import evaluate_dogface_holdout_fusion as tool
...
def test_overwrite_refusal_and_parser_subcommands(tmp_path: Path) -> None:
    ...
    completed = subprocess.run(
        [sys.executable, ROOT / "archive/face/commands/evaluate_dogface_holdout_fusion.py", "--help"],
        cwd=tmp_path,
        check=True,
        capture_output=True,
        text=True,
