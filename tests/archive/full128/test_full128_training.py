...
import archive.full128.methods.training.artifacts as full128_artifacts
...
from archive.full128.methods.preparation.data import (
    Full128Inventory,
    Full128Sample,
    Full128TorchDataset,
    read_full128_crop,
...
from archive.full128.learning.full128 import (
...
from archive.full128.commands.run_full128_training import main as training_workflow
...
def test_training_workflow_uses_run_config_workers_for_assembly_validation(
    ...
    monkeypatch.setattr(
        "archive.full128.commands.run_full128_training.load_full128_assembly", fake_load
    )
    monkeypatch.setattr(
        "archive.full128.commands.run_full128_training.run_full128_training", fake_train
    )
