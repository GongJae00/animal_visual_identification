...
import archive.full128.evaluation.full128 as full128_module
from archive.full128.evaluation.full128 import (
    _METRIC_NAMES,
...
from evaluation.splits.full_split_census import (
    FullStatus,
...
from archive.full128.methods.training.artifacts import file_binding, write_embedding_cache
from archive.full128.methods.preparation.data import Full128Sample
from archive.full128.methods.preparation.inventory import BUNDLE_SCHEMA, INVENTORY_SCHEMA
...
from archive.full128.commands.evaluate_full128_family import main as evaluate_workflow
...
def test_training_family_discovery_and_workflow_contract(
    ...
    monkeypatch.setattr(
        "archive.full128.commands.evaluate_full128_family.validate_full128_experiment_inventory_bundle",
        validate_inventory,
    )
