...
import parsing.export.regions.localizer as localizer_module
...
from parsing.training.regions.nose_dataset import (
...
def test_training_cli_help_does_not_require_training_execution() -> None:
    tool = REPO_ROOT / "archive/nose/commands" / "train_nose_localizer.py"
