...
from shared.contracts.artifact_manifest import ExactOnnxRuntime, NoseMaskManifest, UsageLane
...
from parsing.training.regions.segmentation_training import (
    INTERPRETATION,
    LICENSE_ID,
...
def test_cli_help_avoids_heavy_imports() -> None:
    tool = REPO_ROOT / "archive/nose/commands" / "train_nose_segmentation_student.py"
    command = (
