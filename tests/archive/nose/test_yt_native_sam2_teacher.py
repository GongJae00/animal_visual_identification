...
from parsing.export.regions.localizer import KEYPOINT_ORDER
...
from parsing.training.regions.sam2_teacher import _sam2_runtime_config_name
...
from archive.nose.commands.produce_yt_native_nose_teacher_masks import run as run_tool
...
def test_tool_help_does_not_import_sam2() -> None:
    tool = REPO_ROOT / "archive/nose/commands" / "produce_yt_native_nose_teacher_masks.py"
    command = (
