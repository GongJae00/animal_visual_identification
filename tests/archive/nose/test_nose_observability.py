...
from archive.shared_helpers.experiments.sibetan_evidence import (
...
from archive.nose.commands.audit_nose_observability import run
...
def test_cli_binds_file_and_code_writes_canonical_json_and_refuses_overwrite(
    ...
    assert {
        "archive/nose/experiments/nose_observability.py",
        "archive/shared_helpers/experiments/sibetan_evidence.py",
        "parsing/export/regions/native_yt.py",
        "archive/nose/commands/audit_nose_observability.py",
