...
from enrollment.registry.generated_identity_registry import create_provisional_identity
from data import unified_manifest as build_canid_unified_manifest
from shared.contracts.model_paths import DATASETS_DIR
...
class CanidRegistryTests(unittest.TestCase):
    ...
    def test_petface_remains_blocked_pending_source_binding(self) -> None:
        ...
        self.assertEqual(record.data_root, str(DATASETS_DIR / "petface"))
