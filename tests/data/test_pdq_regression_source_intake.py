...
from data.audit.pdq.source_intake import PdqSelectedSourceMember, PdqSourceContract
...
class PdqRegressionSourceIntakeTests(unittest.TestCase):
    ...
    def _contract() -> PdqSourceContract:
        path = (
            REPO_ROOT
            / "shared/contracts/configs/pdq/threatexchange-pdq-regression-baefb4ed.json"
        )
    ...
    def test_source_only_contract_remains_the_exact_twelve_member_profile(self) -> None:
        source_only_path = (
            REPO_ROOT
            / "shared/contracts/configs/pdq/threatexchange-pdq-baefb4ed.json"
        )
