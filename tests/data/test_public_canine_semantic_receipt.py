...
from data.public_sources.public_canine_manifest import PublicCanineManifest
from data.public_sources.public_canine_semantic_receipt import (
    PublicCanineSemanticReceipt,
    summarize_public_canine_manifest,
)

from tests.repo_root import REPO_ROOT
from tests.data.test_public_canine_manifest import _record
